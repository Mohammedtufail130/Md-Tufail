...
import { Mail, Phone as PhonePortrait, Calendar, MapPin, Facebook, Twitter, Instagram, ChevronDown, Linkedin, Github } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ showContacts, toggleContacts }) => {
  return (
    <aside className={`bg-[#1e1e1f] border border-[#333] rounded-[20px] p-4 md:p-8 ${showContacts ? 'max-h-[500px]' : 'max-h-[180px]'} transition-all duration-500 overflow-hidden lg:sticky lg:top-[60px] lg:max-h-max lg:w-[350px]`}>
      <div className="flex flex-row lg:flex-col items-center gap-4 relative">
        <div className="bg-gradient-to-br from-[#404042] to-[#313133] rounded-[20px] p-2">
          <img 
            src="/pic.png" 
            alt="Mohammed Tufail" 
            className="w-[200px] h-[200px] md:w-[150px] md:h-[150px] rounded-[20px] object-cover" 
          />
        </div>
        
        <div className="info-content">
          <h1 className="text-white text-xl md:text-2xl font-medium mb-2 lg:text-center">Mohammed Tufail</h1>
        ...
        <ul className="space-y-4 lg:space-y-6">
          <li className="flex items-center gap-4">
            ...
            <div>
              ...
              <a href="mailto:mohammedtufail317@gmail.com" className="text-white text-sm md:text-base">Md.Tufail@gmail.com</a>
            </div>
          </li>
          ...
          <li className="flex items-center gap-4">
            ...
            <div>
              ...
              <a href="tel:+918050013741" className="text-white text-sm md:text-base">+91 8050013741</a>
            </div>
          </li>
          ...
          <li className="flex items-center gap-4">
            ...
            <div>
              ...
              <address className="text-white text-sm md:text-base not-italic">Bengaluru, India</address>
            </div>
          </li>
        </ul>
